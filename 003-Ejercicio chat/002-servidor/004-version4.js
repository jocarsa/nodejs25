...
const https = require("https"); // Se requiere el módulo https para SSL

const app = express();
const PORT = 3000;
const FILE_PATH = path.join(__dirname, "mensajes.json");

// Rutas de tus certificados SSL (asegúrate de que las rutas sean correctas)
...
// Crear el servidor HTTPS utilizando los certificados SSL y la aplicación Express
https.createServer(sslOptions, app).listen(PORT, () => {
  console.log(`Servidor HTTPS activo en https://jocarsa.com:${PORT}`);
});
